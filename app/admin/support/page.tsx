                ...
                <Card className="border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-none">
                    <CardHeader className="border-b-4 border-black bg-cyan-50">
                        ...
                        <CardDescription className="font-bold text-black font-mono">
                            Total Messages: {supportMessages.length}
                        </CardDescription>
                    </CardHeader>
                                    ...
                                    {supportMessages.map((msg) => (
                                        <TableRow key={msg.id} className="border-b-2 border-black hover:bg-yellow-50">
                                            ...
                                            <TableCell className="text-sm">
                                                <div className="max-w-[400px] truncate" title={msg.message}>
                                                    {msg.message}
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <Badge variant="outline" className={`font-bold border-2 rounded-none ${msg.status === 'Open' ? 'border-red-500 bg-red-100 text-red-800' :
                                            ...
                                            <TableCell className="text-right">
                                                <Link href={`/admin/support/${msg.id}`}>
